...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D3FTNr8I.js
...
var styles_default = "/assets/styles-B4hBBMei.css";
var APP_NAME = "VELOCITY";
...
var getMarket = createServerFn({ method: "GET" }).validator(object({ feed: _enum([
	...
	"new",
	"boosted"
]) })).handler(createSsrRpc("64d98202a702cce30f6d03486d946fefe11820f2ca69c409a8b8a86c700e5a4d"));
var searchMarket = createServerFn({ method: "GET" }).validator(object({ q: string().max(80) })).handler(createSsrRpc("96f002fc3edb04984e28ab98cf61995a09579acc6f4dd0ab26e970b95e308948"));
var getWatchTokens = createServerFn({ method: "POST" }).validator(object({ mints: array(string().max(64)).max(20) })).handler(createSsrRpc("c84c6c79a413830b98b696289dc6ca666309755bd05b8bf8bab60007c64b2ac2"));
var getPoolChart = createServerFn({ method: "GET" }).validator(object({ pool: string().max(88) })).handler(createSsrRpc("8dcd1a5675eea7408a76b97cd040614c9f3b4e5091aebc868bd83dd018ca5292"));
var $$splitComponentImporter = () => import("./routes-DhReqhm9.mjs");
...
//#endregion
export { getWatchTokens as a, getPoolChart as i, Route as n, searchMarket as o, getMarket as r, router_exports as t };
