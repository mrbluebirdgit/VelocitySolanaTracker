...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CrWFcfCW.mjs");
...
var manifest = {
	"64d98202a702cce30f6d03486d946fefe11820f2ca69c409a8b8a86c700e5a4d": {
		functionName: "getMarket_createServerFn_handler",
		importer: () => import("./api-BMtGwQHr.mjs")
	},
	"8dcd1a5675eea7408a76b97cd040614c9f3b4e5091aebc868bd83dd018ca5292": {
		functionName: "getPoolChart_createServerFn_handler",
		importer: () => import("./api-BMtGwQHr.mjs")
	},
	"96f002fc3edb04984e28ab98cf61995a09579acc6f4dd0ab26e970b95e308948": {
		functionName: "searchMarket_createServerFn_handler",
		importer: () => import("./api-BMtGwQHr.mjs")
	},
	"c84c6c79a413830b98b696289dc6ca666309755bd05b8bf8bab60007c64b2ac2": {
		functionName: "getWatchTokens_createServerFn_handler",
		importer: () => import("./api-BMtGwQHr.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D3FTNr8I.mjs").then((n) => n.t),
